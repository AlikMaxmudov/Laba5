public class AStarPathfinder {
     ...
     *
     * Тут находит путь, если найдет путевая точка возвращается.
     * А так же возвращается обратно к точке, если путь не найдет.
     *
     **/
     ...
     * two locations.
     *
     * Тут рассчитывается расстояние между прямой и двуми точками.
     **/
